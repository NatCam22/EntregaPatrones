...
//Los typealias es como definir un tipo nuevo a partir de otro que ya existe
//En este caso tomamos un arreglo de Character y definimos el tipo "arreglo de characters" como Characters
...
//Los datos que tenemos: (copiado del repo)
...
var sampleCharacterData: CharactersModel = [
    ...
    CharacterModel(
        name: "Mona J. Simpson",
        job: "Fugitivo Ex hippie y activista pol’tico",
        image: "mona_simpson",
